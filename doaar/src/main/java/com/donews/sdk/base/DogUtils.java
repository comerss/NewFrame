...
public class DogUtils {
    ...
    public static boolean b(Context var0, String var1) {
        boolean var2 = false;
        if (null != var0 && !TextUtils.isEmpty(var1)) {
    ...
    public static boolean a(Context var0, Intent var1) {
        if (var1 == null) {
            ...
            List var3 = var2.queryIntentActivities(var1, PackageManager.MATCH_DEFAULT_ONLY);
    ...
    public static boolean a() {
        ...
        try {
            var0 = !TextUtils.isEmpty(Build.BRAND) && Build.BRAND.toLowerCase().startsWith("huawei") || !TextUtils.isEmpty(Build.MANUFACTURER) && Build.MANUFACTURER.toLowerCase().startsWith("huawei");
...
//            LogUtils.a("DogUtils", "Unable to read sysprop " + var0, var14);
            var4 = var1;
        } finally {
            if (var2 != null) {
                try {
...
//                    LogUtils.a("DogUtils", "Exception while closing InputStream", var13);
                }
            }
    ...
    public static boolean c(Context var0, String var1) {
        boolean var2 = false;
        if (var0 != null && var1 != null && !TextUtils.isEmpty(var1)) {
            try {
                File var3 = new File(var1);
                if (var3.exists()) {
                    PackageManager var4 = var0.getPackageManager();
                    PackageInfo var5 = var4.getPackageArchiveInfo(var3.getAbsolutePath(), PackageManager.GET_ACTIVITIES);
                    if (var5 == null) {
                        return var2;
                    }
                    ...
                    try {
                        var8 = var0.getPackageManager().getPackageInfo(var6, PackageManager.GET_ACTIVITIES);
