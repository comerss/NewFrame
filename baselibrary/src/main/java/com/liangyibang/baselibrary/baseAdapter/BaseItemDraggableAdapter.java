...
import com.liangyibang.baselibrary.baseAdapter.listener.OnItemDragListener;
import com.liangyibang.baselibrary.baseAdapter.listener.OnItemSwipeListener;
...
public abstract class BaseItemDraggableAdapter<T, K extends BaseViewHolder> extends BaseQuickAdapter<T, K> {
    ...
    public BaseItemDraggableAdapter(Context context,int layoutResId, List<T> data) {
