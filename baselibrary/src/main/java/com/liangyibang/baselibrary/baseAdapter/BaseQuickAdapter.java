 ...
 */
package com.liangyibang.baselibrary.baseAdapter;
...
import com.liangyibang.baselibrary.baseAdapter.animation.AlphaInAnimation;
import com.liangyibang.baselibrary.baseAdapter.animation.BaseAnimation;
import com.liangyibang.baselibrary.baseAdapter.animation.ScaleInAnimation;
import com.liangyibang.baselibrary.baseAdapter.animation.SlideInBottomAnimation;
import com.liangyibang.baselibrary.baseAdapter.animation.SlideInLeftAnimation;
import com.liangyibang.baselibrary.baseAdapter.animation.SlideInRightAnimation;
import com.liangyibang.baselibrary.baseAdapter.entity.IExpandable;
import com.liangyibang.baselibrary.baseAdapter.loadmore.LoadMoreView;
import com.liangyibang.baselibrary.baseAdapter.loadmore.SimpleLoadMoreView;
import com.liangyibang.baselibrary.baseAdapter.util.MultiTypeDelegate;
...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
     ...
     */
    public BaseQuickAdapter(Context context,@LayoutRes int layoutResId, @Nullable List<T> data) {
    ...
    public BaseQuickAdapter(Context context,@Nullable List<T> data) {
        this(context,0, data);
    }
    public BaseQuickAdapter() {
    }
    public BaseQuickAdapter(Context context,@LayoutRes int layoutResId) {
