...
public class AndroidInstantRuntime {
    public static void setLogger(Logger logger) {
        Log.logging = new Log.Logging() {
            public void log(Level level, String string) {
                this.val$logger.log(level, string);
            }
            ...
            public void log(Level level, String string, Throwable throwable) {
                this.val$logger.log(level, string, throwable);
            }
        };
    }
        ...
        try {
            ...
            if (Log.logging != null) {
                Log.logging.log(Level.SEVERE,
                        String.format("Exception during setPrivateField %s", new Object[]{fieldName}), e);
            }
    ...
    public static Object getPrivateField(Object targetObject, Class targetClass, String fieldName) {
        try {
            ...
            if (Log.logging != null) {
                Log.logging.log(Level.SEVERE,
                        String.format("Exception during%1$s getField %2$s", new Object[]{targetObject == null ? " static" : "", fieldName}), e);
            }
    ...
    public static Object invokeProtectedMethod(Object receiver, Object[] params, Class[] parameterTypes, String methodName)
            throws Throwable {
        ...
        try {
            ...
            Log.logging.log(Level.SEVERE, String.format("Exception while invoking %s", new Object[]{methodName}), e);
            throw new RuntimeException(e);
        }
    }


    public static Object invokeProtectedStaticMethod(Object[] params, Class[] parameterTypes, String methodName, Class receiverClass)
            throws Throwable {
        if ((Log.logging != null) && (Log.logging.isLoggable(Level.FINE))) {
            Log.logging.log(Level.FINE,
                    String.format("protectedStaticMethod:%s on %s", new Object[]{methodName, receiverClass.getName()}));
        }
        try {
    ...
    public static <T> T newForClass(Object[] params, Class[] paramTypes, Class<T> targetClass) throws Throwable {
        try {
            ...
            Log.logging.log(Level.SEVERE, "Exception while resolving constructor", e);
            throw new RuntimeException(e);
        }
        Constructor declaredConstructor;
        declaredConstructor.setAccessible(true);
        try {
            return (T) targetClass.cast(declaredConstructor.newInstance(params));
        } catch (InvocationTargetException e) {
            throw e.getCause();
        } catch (InstantiationException e) {
            Log.logging.log(Level.SEVERE, String.format("Exception while instantiating %s", new Object[]{targetClass}), e);
            throw new RuntimeException(e);
        } catch (IllegalAccessException e) {
            Log.logging.log(Level.SEVERE, String.format("Exception while instantiating %s", new Object[]{targetClass}), e);
            throw new RuntimeException(e);
    ...
    private static Method getMethodByName(Class<?> aClass, String name, Class[] paramTypes) {
        ...
        while (currentClass != null) {
            ...
            if ((Log.logging != null) && (Log.logging.isLoggable(Level.FINE))) {
                Log.logging.log(Level.FINE, String.format("getMethodByName:Looking in %s now", new Object[]{currentClass
                        .getName()}));
            }
        }
...
/* Location:              /Volumes/Work/works/Diooto/app/build/intermediates/incremental-runtime-classes/debug/instant-run.jar!/com/android/tools/ir/runtime/AndroidInstantRuntime.class
