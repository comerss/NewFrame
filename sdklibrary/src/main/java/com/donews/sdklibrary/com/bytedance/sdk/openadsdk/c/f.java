...
/*      */ public class f
/*      */ {
/*  335 */   public static final String[] a = { "_id", "_data AS local_filename", "mediaprovider_uri", "destination", "title", "description", "icon_url", "uri", "status", "hint", "mimetype AS media_type", "total_bytes AS total_size", "lastmod AS last_modified_timestamp", "current_bytes AS bytes_so_far", "allow_write", "etag", "'placeholder' AS local_uri", "'placeholder' AS reason" };
/*      */   
/*      */ 
/*      */ 
/*      */ 
...
/*  497 */           throw new IllegalStateException(localFile.getAbsolutePath() + " already exists and is not a directory");
/*      */         }
/*      */         
/*      */       }
...
/*  688 */       if ((!a) && (this.b == null)) throw new AssertionError();
...
/*      */       
/*  843 */       if (this.a != null) {
/*  844 */         localArrayList1.add(f.e(this.a));
/*  845 */         localArrayList2.addAll(Arrays.asList(f.f(this.a)));
/*      */       }
/*      */       
/*  848 */       if (this.b != null) {
/*  849 */         localArrayList1.add(f.a(this.b));
/*  850 */         localArrayList2.addAll(Arrays.asList(f.b(this.b)));
/*      */       }
/*      */       
/*  853 */       if (this.c != null) {
/*  854 */         localObject = new ArrayList();
...
/*      */ 
/*      */ 
/*  922 */   private Uri f = m.a.a;
/*      */   private static f g;
/*      */   
/*      */   public static synchronized f a(Context paramContext) {
/*  926 */     if (g == null) {
...
/*  935 */     this.d = i.a(this.b.getApplicationContext());
...
/* 1007 */       long l2; if (l1 == -1L) {
/* 1008 */         ContentValues localContentValues = paramc.b(this.e);
/* 1009 */         Uri localUri = this.d.a(m.a.a, localContentValues);
...
/*      */     {
/* 1026 */       b localb = new b();
/* 1027 */       localb.a(new String[] { c.a(paramc).toString() });
/* 1028 */       localCursor = a(localb);
...
/*      */             {
/* 1042 */               HttpURLConnection localHttpURLConnection = null;
/*      */               try
/*      */               {
/* 1045 */                 URL localURL = new URL(f.c.a(paramc).toString());
/* 1046 */                 localHttpURLConnection = (HttpURLConnection)localURL.openConnection();
/* 1047 */                 localHttpURLConnection.setInstanceFollowRedirects(false);
/* 1048 */                 localHttpURLConnection.setConnectTimeout(20000);
/* 1049 */                 localHttpURLConnection.setReadTimeout(20000);
/* 1050 */                 localHttpURLConnection.addRequestProperty("User-Agent", b.b);
/* 1051 */                 localHttpURLConnection.setRequestProperty("Accept-Encoding", "identity");
/* 1052 */                 localHttpURLConnection.addRequestProperty("If-None-Match", str);
/* 1053 */                 int i = localHttpURLConnection.getResponseCode();
/* 1054 */                 if (i == 304) {
/* 1055 */                   f.a(f.this, l1);
/*      */                 } else {
/* 1057 */                   f.this.a(f.c.b(paramc), new long[] { l1 });
/*      */                 }
/*      */               } catch (Exception localException) {
...
/*      */   {
/* 1094 */     Uri localUri = ContentUris.withAppendedId(m.a.a, paramLong);
/* 1095 */     Cursor localCursor = this.d.a(localUri, null, null, null, null);
/*      */     try { int i;
...
/* 1111 */         this.d.a(localUri, localContentValues, null, null);
...
/*      */ 
/*      */ 
/*      */   public int a(long... paramVarArgs)
/*      */   {
/*      */     try
/*      */     {
/* 1147 */       if ((paramVarArgs == null) || (paramVarArgs.length == 0))
/*      */       {
/* 1149 */         throw new IllegalArgumentException("input param 'ids' can't be null");
/*      */       }
/* 1151 */       ContentValues localContentValues = new ContentValues();
/* 1152 */       localContentValues.put("deleted", Integer.valueOf(1));
/*      */       
/*      */ 
/* 1155 */       if (paramVarArgs.length == 1) {
/* 1156 */         return this.d.a(ContentUris.withAppendedId(this.f, paramVarArgs[0]), localContentValues, null, null);
/*      */       }
/*      */       
/* 1159 */       return this.d.a(this.f, localContentValues, e(paramVarArgs), 
/* 1160 */         f(paramVarArgs));
/*      */     }
/*      */     catch (Exception localException) {}
/* 1163 */     return -1;
...
/*      */   {
/* 1175 */     Cursor localCursor = a(new b().a(paramVarArgs));
/*      */     try {
...
/*      */         {
/*      */ 
/* 1184 */           throw new IllegalArgumentException("Can only pause a running download: " + localCursor.getLong(localCursor
...
/* 1192 */       this.d.a(this.f, localContentValues, e(paramVarArgs), 
...
/*      */   {
/* 1215 */     Cursor localCursor = a(new b().a(paramVarArgs));
/*      */     try {
...
/*      */         {
/*      */ 
/* 1224 */           throw new IllegalArgumentException("Cann only resume a paused download: " + localCursor.getLong(localCursor
...
/*      */ 
/*      */ 
/* 1240 */       localContentValues = new ContentValues();
/*      */     }
/*      */     catch (Exception localException2)
/*      */     {
...
/* 1243 */     this.d.a(this.f, localContentValues, e(paramVarArgs), 
/* 1244 */       f(paramVarArgs));
/*      */   }
/*      */   
/*      */ 
...
/*      */ 
/*      */ 
/*      */   public Cursor a(b paramb)
/*      */   {
/* 1267 */     Cursor localCursor = paramb.a(this.d, a, this.f);
/* 1268 */     if (localCursor == null) {
/* 1269 */       return null;
/*      */     }
/* 1271 */     return new a(localCursor, this.f, this.b);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */ 
/*      */ 
/*      */   public void a(int paramInt, long... paramVarArgs)
/*      */   {
/* 1371 */     Cursor localCursor = a(new b().a(paramVarArgs));
/*      */     try {
...
/* 1389 */       this.d.a(this.f, localContentValues, e(paramVarArgs), f(paramVarArgs)); return;
/*      */     }
/*      */     catch (Exception localException2) {}finally
/*      */     {
/*      */       try {
...
/*      */     private Context b;
/*      */     
/*      */     public a(Cursor paramCursor, Uri paramUri, Context paramContext)
/*      */     {
/* 1503 */       super();
...
/* 1518 */         return f.a(super.getInt(getColumnIndex("status")));
/*      */       }
...
/*      */   }
/*      */   
/*      */   public static int a(Context paramContext, int paramInt, long paramLong)
/*      */   {
/* 1642 */     return a(paramContext, paramInt, paramLong, null);
/*      */   }
/*      */   
/*      */   public static int a(Context paramContext, int paramInt, long paramLong, String paramString) {
...
/* 1659 */             j = 2;
/*      */           }
/* 1661 */           a(paramContext).a(j, new long[] { paramLong });
/* 1662 */           i = 1; }
/* 1663 */         break;
/*      */       
/*      */       case 4: 
/* 1666 */         if (paramLong >= 0L) {
/* 1667 */           a(paramContext).c(new long[] { paramLong });
/* 1668 */           i = 2;
/*      */         }
/*      */         break;
/*      */       case 1: 
...
/* 1674 */           a(paramContext).b(new long[] { paramLong });
/* 1675 */           i = 4;
/*      */         }
/*      */         break;
/*      */       case 8: 
...
/*      */   }
/*      */   
/*      */   static void a(com.bytedance.sdk.openadsdk.c.a.b paramb) {
/* 1697 */     n.a(paramb);
/*      */   }
/*      */ }


/* Location:              C:\Users\79653\Desktop\back\open_ad_sdk\classes.jar!\com\bytedance\sdk\openadsdk\c\f.class
