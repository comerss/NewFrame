...
/*  49 */           com.bytedance.sdk.openadsdk.d.c.h(paramContext, paramh, paramString, "open_url_app");
/*  50 */           return true;
/*     */         }
/*  52 */         str = locald.b();
/*     */       }
...
/*  55 */         str = locald.b();
/*     */       }
/*  57 */       com.bytedance.sdk.openadsdk.d.c.h(paramContext, paramh, paramString, "open_fallback_url");
/*     */     }
/*     */     else {
/*  60 */       str = paramh.e();
/*     */     }
/*  62 */     if (!q.a(str)) {
/*  63 */       if (paramh.c() == 2) {
/*  64 */         if (!com.bytedance.sdk.openadsdk.g.c.a(str)) {
/*  65 */           return false;
/*     */         }
