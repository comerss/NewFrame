...
/*      */   
/*      */ 
/*      */   private static Bitmap a(String paramString, byte[] paramArrayOfByte, Options paramOptions, boolean paramBoolean)
/*      */   {
...
/*      */   
/*      */ 
/*      */   private static Bitmap a(String paramString, Options paramOptions, boolean paramBoolean)
/*      */   {
/*  275 */     Bitmap localBitmap = null;
/*      */     
/*  277 */     if (paramOptions == null) {
/*  278 */       paramOptions = new Options();
/*      */     }
/*      */     
...
/*      */     }
/*  411 */     Options localOptions = null;
/*      */     
/*  413 */     if (paramInt1 > 0)
/*      */     {
/*  415 */       localObject = new Options();
/*  416 */       ((Options)localObject).inJustDecodeBounds = true;
/*      */       
/*  418 */       a(paramString, paramArrayOfByte, (Options)localObject, paramBoolean2);
/*      */       
/*  420 */       int i1 = ((Options)localObject).outWidth;
/*  421 */       if (!paramBoolean1) i1 = Math.max(i1, ((Options)localObject).outHeight);
/*  422 */       int i2 = a(i1, paramInt1);
/*      */       
/*  424 */       localOptions = new Options();
...
/*      */   }
/*      */   
/*  569 */   private static Bitmap x = Bitmap.createBitmap(1, 1, Config.ALPHA_8);
/*      */   
/*  571 */   public static Bitmap getEmptyBitmap() { return x; }
/*      */   
/*      */ 
/*  574 */   private static Bitmap y = Bitmap.createBitmap(1, 1, Config.ALPHA_8);
/*      */   
/*      */ 
/*      */ 
/*      */ 
...
/* 1127 */       return null;
/*      */     }
/* 1129 */     Bitmap localBitmap = Bitmap.createBitmap(paramBitmap.getWidth(), paramBitmap.getHeight(), Config.ARGB_8888);
