...
/*  43 */     int j = 0;
/*  44 */     for (Entry localEntry : localMap.entrySet()) {
/*  45 */       j++;
/*  46 */       if (j > 5L)
/*     */         break;
...
/*  97 */           localObject = ((RunningTaskInfo)localList.get(0)).topActivity;
...
/* 104 */         for (localObject = localList.iterator(); ((Iterator)localObject).hasNext();) { RunningAppProcessInfo localRunningAppProcessInfo = (RunningAppProcessInfo)((Iterator)localObject).next();
...
/* Location:              C:\Users\79653\Desktop\back\open_ad_sdk\classes.jar!\com\ss\android\crash\log\e.class
