...
/*     */ 
/*     */ public class j
/*     */   implements MediaScannerConnectionClient, t.a
/*     */ {
...
/*     */   {
/*  86 */     if (b.c) Log.v("SsDownloadManager", "requestScan() for " + paramd.e);
...
/*     */     
/*     */ 
/* 147 */     ??? = new ContentValues();
/* 148 */     ((ContentValues)???).put("scanned", Integer.valueOf(1));
/* 149 */     if (localUri1 != null) {
/* 150 */       ((ContentValues)???).put("mediaprovider_uri", localUri1.toString());
/*     */     }
/*     */     
/* 153 */     i locali = i.a(this.b);
/* 154 */     Uri localUri2 = ContentUris.withAppendedId(m.a.a, locala.a);
/*     */     
/* 156 */     int i = locali.a(localUri2, (ContentValues)???, null, null);
/* 157 */     if (i == 0)
/*     */     {
/*     */ 
/* 160 */       if (this.b != null) {
...
/* Location:              C:\Users\79653\Desktop\back\open_ad_sdk\classes.jar!\com\bytedance\sdk\openadsdk\c\j.class
