...
/*     */     
/* 102 */     int i = !TextUtils.isEmpty(VERSION.RELEASE) ? 1 : 0;
/* 103 */     int j = !TextUtils.isEmpty(Build.ID) ? 1 : 0;
/*     */     
/* 105 */     int k = ("REL".equals(VERSION.CODENAME)) && (!TextUtils.isEmpty(Build.MODEL)) ? 1 : 0;
/*     */     
/* 107 */     localStringBuilder.append("SsAndroidDownloadManager");
/* 108 */     if (i != 0) {
/* 109 */       localStringBuilder.append("/").append(VERSION.RELEASE);
/*     */     }
/* 111 */     localStringBuilder.append(" (Linux; U; Android");
/* 112 */     if (i != 0) {
/* 113 */       localStringBuilder.append(" ").append(VERSION.RELEASE);
/*     */     }
/* 115 */     if ((k != 0) || (j != 0)) {
...
/* Location:              C:\Users\79653\Desktop\back\open_ad_sdk\classes.jar!\com\bytedance\sdk\openadsdk\c\b.class
