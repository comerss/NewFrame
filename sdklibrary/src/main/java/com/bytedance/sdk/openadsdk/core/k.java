...
/*  86 */         String str1 = i.a(this.a);
/*  87 */         if (!TextUtils.isEmpty(str1)) {
/*  88 */           localHashMap.put("device_id", str1);
/*     */         }
/*  90 */         localHashMap.put("ac", com.bytedance.sdk.openadsdk.ggg.c.b(this.a));
...
/*     */         
/* 112 */         localHashMap.put("openudid", i.c(this.a));
/* 113 */         localHashMap.put("dpi", this.a.getApplicationContext().getResources().getDisplayMetrics().densityDpi + "");
/* 114 */         DisplayMetrics localDisplayMetrics = this.a.getResources().getDisplayMetrics();
