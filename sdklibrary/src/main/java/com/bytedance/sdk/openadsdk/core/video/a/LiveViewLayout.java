...
public class LiveViewLayout implements c, d, MineHandler.OnResult {
    private static final String c = LiveViewLayout.class.getSimpleName();
    ...
    private Runnable B = new Runnable() {
        public void run() {
            if (LiveViewLayout.this.mPlayeWrapper != null) {
                LiveViewLayout.this.mPlayeWrapper.d();
            }
    ...
    private Runnable C = new Runnable() {
        public void run() {
            if (LiveViewLayout.this.j != null) {
                LiveViewLayout.this.j.a();
            }
    ...
    private Runnable D = new Runnable() {
        public void run() {
            if (LiveViewLayout.this.mPlayeWrapper != null) {
                if (LiveViewLayout.this.m <= 0L) {
                    LiveViewLayout.this.mPlayeWrapper.d();
                }

                LiveViewLayout.this.mPlayeWrapper.e();
            }

            LiveViewLayout.this.mMineHandler.postDelayed(this, 200L);
        }
    };
    ...
    private void b(Context var1) {
        ...
        this.mLiveViewLayout = new NewLiveViewLayout(var1, LayoutInflater.from(var1.getApplicationContext()).inflate(R.layout.tt_video_play_layout_for_live, (ViewGroup)null, false), true, var2, this.mNativeAdData, this);
        this.mLiveViewLayout.a(this);
    }

    public LiveViewLayout(Context var1, ViewGroup var2, NativeAdData var3) {
        this.e = var2;
        this.mContextWeakReference = new WeakReference(var1);
        this.mNativeAdData = var3;
        this.b(var1);
    ...
    private void a(String var1) throws Exception {
        ...
        if (!StringUtils.isEmpty(var1)) {
            ...
            this.a(new Runnable() {
                public void run() {
                    LiveViewLayout.this.g = System.currentTimeMillis();
                    LiveViewLayout.this.mLiveViewLayout.d(0);
                    if (LiveViewLayout.this.mPlayeWrapper != null && LiveViewLayout.this.k == 0L) {
                        LiveViewLayout.this.mPlayeWrapper.a(true, 0L, !LiveViewLayout.this.v);
                    } else if (LiveViewLayout.this.mPlayeWrapper != null) {
                        LiveViewLayout.this.mPlayeWrapper.a(true, LiveViewLayout.this.k, !LiveViewLayout.this.v);
                    }

                    if (LiveViewLayout.this.mMineHandler != null) {
                        LiveViewLayout.this.mMineHandler.postDelayed(LiveViewLayout.this.B, 100L);
                    }
    ...
    private void c(int var1) {
        if (this.s()) {
            if (this.mLiveViewLayout != null) {
                ...
                this.mLiveViewLayout.a(this.mNativeAdData, this.mContextWeakReference, true);
                if (!this.s) {
                    AdEvent.a((Context)this.mContextWeakReference.get(), this.mNativeAdData, "embeded_ad", "feed_over", this.e(), 100);
                    this.s = true;
    ...
    public void c() {
        ...
        this.r();
        if (!this.s && this.r) {
            AdEvent.a(mContextWeakReference.get(), this.mNativeAdData, "embeded_ad", "feed_break", this.e(), this.k());
            this.s = true;
        }
            ...
            switch(var1.what) {
                ...
                case 304:
                    ...
                    if (this.q && var2 == 3 && !this.r) {
                        if (this.u) {
                            AdEvent.f((Context)this.mContextWeakReference.get(), this.mNativeAdData, "embeded_ad", "feed_auto_play");
                        } else {
                            AdEvent.f((Context)this.mContextWeakReference.get(), this.mNativeAdData, "embeded_ad", "feed_play");
                        }
    ...
    public void a(b var1, View var2) {
        if (this.mPlayeWrapper != null && this.s()) {
            ...
            } else if (!this.mPlayeWrapper.start()) {
                if (this.mLiveViewLayout != null) {
                    this.mLiveViewLayout.a(this.e);
                }
    ...
    public void a(com.bytedance.sdk.openadsdk.core.widget.a var1, float var2, boolean var3) {
        if (this.s()) {
            if (var1 != null && this.mPlayeWrapper != null && (this.mPlayeWrapper.f() || this.mPlayeWrapper.start())) {
    ...
    protected boolean b(int var1) {
        ...
        if (var2 == NetUtils.a.a) {
            this.mLiveViewLayout.a(this.mNativeAdData, this.mContextWeakReference, false);
        }
        ...
        if (var2 != NetUtils.a.e && var2 != NetUtils.a.a) {
            ...
            this.y = true;
            this.z = false;
            if (this.mLiveViewLayout != null && this.mNativeAdData != null) {
                return this.mLiveViewLayout.a(var1, this.mNativeAdData.a());
            }
