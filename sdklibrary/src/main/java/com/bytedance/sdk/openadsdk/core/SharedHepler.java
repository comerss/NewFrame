...
/*    */ {
/* 27 */   private static volatile SharedHepler a = null;
/*    */   
/* 29 */   private SharedPreferences b = null;
/*    */   
/*    */   private SharedHepler(Context paramContext) {
/* 32 */     this.b = paramContext.getSharedPreferences("ttopenadsdk", 0);
/*    */   }
/*    */   
/*    */   public static SharedHepler getInstance(Context paramContext) {
/* 36 */     if (null == a) {
/* 37 */       synchronized (SharedHepler.class) {
/* 38 */         if (null == a) {
/* 39 */           a = new SharedHepler(paramContext);
/*    */         }
/*    */       }
/*    */     }
/* 43 */     return a;
...
/* Location:              C:\Users\79653\Desktop\back\open_ad_sdk\classes.jar!\com\bytedance\sdk\openadsdk\core\VideoManager.class
