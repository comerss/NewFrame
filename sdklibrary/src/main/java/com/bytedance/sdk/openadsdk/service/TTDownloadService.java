...
/*     */ 
/*     */ 
/* 245 */   private Handler.Callback l = new Handler.Callback()
/*     */   {
/*     */     @TargetApi(5)
...
/*     */       {
/*     */ 
/* 270 */         for (??? = Thread.getAllStackTraces().entrySet().iterator(); ((Iterator)???).hasNext();) { Map.Entry localEntry = (Map.Entry)((Iterator)???).next();
