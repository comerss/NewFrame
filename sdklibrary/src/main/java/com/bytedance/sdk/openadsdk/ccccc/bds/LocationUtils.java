...
/*     */           } else {
/* 217 */             bool = parame.a(str, com.bytedance.sdk.openadsdk.ccccc.bds.c.c.a);
/*     */           }
/* 219 */           if (bool) {
/*     */             break;
/*     */           }
...
/* 249 */         if (parame != null) {
/* 250 */           parame.a(str, com.bytedance.sdk.openadsdk.ccccc.bds.c.c);
/*     */         }
/* 252 */       } else if (!a(paramActivity, str)) {
/* 253 */         localArrayList.add(str);
/*     */       }
/* 255 */       else if (parame != null) {
/* 256 */         parame.a(str, com.bytedance.sdk.openadsdk.ccccc.bds.c.a);
/*     */       }
/*     */     }
/*     */
...
/* 310 */        e localObject = (e)((WeakReference)localIterator.next()).get();
